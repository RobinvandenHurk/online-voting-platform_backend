package com.robinvandenhurk.gateway.example.serviceauthorization.config.binding;

import com.robinvandenhurk.gateway.example.serviceauthorization.config.exchange.UserExchange;

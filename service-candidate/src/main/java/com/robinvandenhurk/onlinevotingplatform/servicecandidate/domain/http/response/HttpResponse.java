package com.robinvandenhurk.onlinevotingplatform.servicecandidate.domain.http.response;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.robinvandenhurk.onlinevotingplatform.servicecandidate.domain.http.response.data.BadRequestResponseData;
